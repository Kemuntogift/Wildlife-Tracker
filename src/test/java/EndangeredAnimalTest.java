...
public class EndangeredAnimalTest {
    ...
    public void EndangeredAnimal_instantiatesWithName_String() {
        EndangeredAnimal testEndangeredAnimal = new EndangeredAnimal("Kangaroo", "okay", "young");
    ...
    public void equals_returnsTrueIfNameAndTypeAreSame_true() {
        EndangeredAnimal testEndangeredAnimal = new EndangeredAnimal("Kangaroo", "okay", "young");
        EndangeredAnimal anotherEndangeredAnimal = new EndangeredAnimal("Kangaroo", "okay", "young");
    ...
    public void all_returnsAllInstancesOfEndangeredAnimal_true() {
        EndangeredAnimal firstEndangeredAnimal = new EndangeredAnimal("Kangaroo", "okay", "young");
        firstEndangeredAnimal.save();
        EndangeredAnimal secondEndangeredAnimal = new EndangeredAnimal("Panda", "ill", "adult");
